...
public class ConfigManager {
    ...
    private List<String> explosionWhitelist;
    ...
    public void validate() {
        ...
        this.explosionWhitelist = this.config.getStringList("explosion-whitelist");
    ...
    public List<String> getExplosionWhitelist() {
        return explosionWhitelist;
    }
